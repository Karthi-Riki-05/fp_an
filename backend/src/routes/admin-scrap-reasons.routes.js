...
const svc = require('../services/admin-scrap-reasons.service');

const router = Router();
router.use(tenantMiddleware, requirePermission('manage-scrap-reasons'));

/**
 * @swagger
 * /api/v1/admin/scrap-reasons:
 *   get:
 *     tags: ["Admin — Scrap Reasons"]
 *     summary: GET /
 *     security:
 *       - access_token: []
 *     responses:
