...
const adminIconsRoutes = require('./routes/admin-icons.routes');
...
const superadminMqttRoutes = require('./routes/superadmin-mqtt.routes');
...
app.use('/api/v1/admin/icons', adminIconsRoutes);
...
app.use('/api/v1/superadmin', superadminMqttRoutes);
